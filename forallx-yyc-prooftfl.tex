...
\end{fitchproof}
Note that we have numbered the premise, since we will want to refer back to it. Indeed, every line in theFix a proof is numbered, so that we can refer back to it.
...
Here is a third, related, bit of terminology:
	...
	\define{jointly inconsistent} iff the contradiction~$\ered$ can be proved from
