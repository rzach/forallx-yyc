...
\end{fitchproof}
Note that we have numbered the premise, since we will want to refer back to it. Indeed, every line on the proof is numbered, so that we can refer back to it.
