...
is not. Some logicians have proposed that in cases of sentences
like `Jan is bald' which allow borderline cases, we have to adjust our
semantics and allow that the sentence letter~`$J$' that symbolizes it
should be allowed to take truth values other than $\TTbf{T}$ and
$\TTbf{F}$. But this is by no means universally accepted.
