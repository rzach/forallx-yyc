...
notions. E.g., for \define{nomological validity}, counterexamples that
violate the laws of nature are excluded. So, we might call an argument
\define{nomologically valid} if there are no counterexamples that
don't violate the laws of nature, and an argument \define{conceptually
valid} if there are no counterexamples that don't violate conceptual
