...
\begin{center}
	...
	\end{tikzpicture}
\end{bmlimage}\bmlDescription{The numbers 1 and 2 are connected
by arrows. There are arrows from 1 to itself, and from 2 to
1. Node 1 is labelled by A and not-B. Node 2 is labelled by not-A and B.}
\end{center}
...
\begin{bmlimage}
	...
	\end{tikzpicture}
\end{bmlimage}\bmlDescription{The numbers 1 and 2 are connected
by an arrow from 1 to 2. Node 1 is labelled not-A and node 2 is
labelled A.}
\end{center}
