...
\begin{fitchproof}
	...
	\open
		...
		\have[l]{c2}{\metav{C}}
	\close
	\have[\quad]{c}{\metav{C}} \oe{ab,a-c1, b-c2}
\end{fitchproof}
...
\begin{fitchproof}
	...
	\open
		...
		\have[l]{a2}{\metav{A}}
	\close
	\have[\quad]{ab}{\metav{A}\eiff\metav{B}}\bi{a1-b1,b2-a2}
\end{fitchproof}
\begin{fitchproof}
...
\subsection*{Excluded middle}
	\begin{fitchproof}
		...
		\open
			...
			\have[l]{c2}{\metav{B}}
		\close
		\have[\quad]{ab}{\metav{B}}\tnd{a-c1,b-c2}
	\end{fitchproof}
...
\begin{fitchproof}
	\have[\quad]{x}{\metav{c}=\metav{c}} \by{=I}{}
\end{fitchproof}
